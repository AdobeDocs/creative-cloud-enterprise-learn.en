...
| Graph template | Description | Use cases |
|---|---|---|
| [**Getting started - Video generation**](/help/firefly/graph/templates/get-started-video-gen.md) | Feed in an approved still key art and a short motion prompt. | <ul><li>Key art to video</li><li>Launch teaser</li><li>Video cut</li></ul> |
| [**Bullet Time VFX**](/help/firefly/graph/templates/bullet-time-vfx.md) | Feed a hero product or subject image to generate a rotating sequence of angles around it, then stitch the freeze frame sweep automatically. | <ul><li>Bullet time shot</li><li>360 freeze frame</li><li>Rotating hero shot</li></ul> |

## Storyboarding

| Graph template | Description | Use cases |
|---|---|---|
| [**Text to storyboard**](/help/firefly/graph/templates/text-to-storyboard.md) | Replace text input nodes with elements from your story. | <ul><li>Script to storyboard</li><li>Launch storyboard</li><li>Explainer storyboard</li></ul> |
| [**Storyboard builder**](/help/firefly/graph/templates/storyboard-builder.md) | Build a storyboard scene by scene, adding one node per beat of the narrative. | <ul><li>Narrative structure test</li><li>Pacing test</li><li>Narrative arc</li></ul> |

## 3D & character

| Graph template | Description | Use cases |
|---|---|---|
| [**Real time shaders**](/help/firefly/graph/templates/real-time-shaders.md) | Start with an image and apply three different custom shaders, previewing the result in real time. | <ul><li>Configurator shader</li><li>Paint material preview</li><li>Product render</li></ul> |
| [**Character model generation**](/help/firefly/graph/templates/character-model-generation.md) | Create a 3D animated style of an illustration. | <ul><li>Mascot model</li><li>Base 3D model</li><li>Instructor model</li></ul> |
| [**Vinyl toy design**](/help/firefly/graph/templates/vinyl-toy-design.md) | Input a character or mascot reference, and render it in a stylized vinyl toy form. | <ul><li>Collectible concept</li><li>Mascot figure</li><li>Licensing pitch</li></ul> |
| [**Sketch to 3D turnaround**](/help/firefly/graph/templates/sketch-to-3d.md) | Turn a sketch into a 3D character. | <ul><li>Hardware turnaround</li><li>Vehicle & Prop turnaround</li><li>Character turnaround</li></ul> |

## Product & brand mockups

| Graph template | Description | Use cases |
|---|---|---|
| [**Branding visualization**](/help/firefly/graph/templates/branding-visualization.md) | Visualize a logo or brand in product scenes. | <ul><li>Sub-brand visual</li><li>Palette test</li><li>Identity preview</li></ul> |
...
| Graph template | Description** | Use cases |
|---|---|---|
| [**Design system generator**](/help/firefly/graph/templates/design-system-generator.md) | Generate a design system based on a website screenshot. | <ul><li>Icon pattern set</li><li>Color system</li><li>Visual language</li></ul> |
| [**Headshots generation**](/help/firefly/graph/templates/headshots-generation.md) | Harmonize a batch of corporate headshots. | <ul><li>Directory headshots</li><li>Team page headshots</li><li>Professional headshots</li></ul> |
