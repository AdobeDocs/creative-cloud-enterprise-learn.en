---
title: Selective Color Correction
description: Learn how to mask a specific region that needs correction and set the target color on that node only
...
Learn how to mask a specific region that needs correction and set the target color on that node only. The rest of the image passes through the graph untouched. [Open Selective color correction template](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:92c1c93e-4a12-5c99-a2d7-a06ad1662125).
