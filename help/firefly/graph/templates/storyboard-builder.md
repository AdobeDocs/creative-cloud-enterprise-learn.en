...
description: Learn how to turn your ideas into a storyboard automatically using text prompts
...
Learn how to turn your ideas into a storyboard automatically using text prompts. Build scene by scene, adding one node per beat of the narrative. Reorder nodes to test a different sequence before locking the final panel order. [Open Storyboard builder template](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:962af654-f338-58eb-ac9a-3ce151c2f4bc).
