...
description: Learn how to input a model reference and swap the garment input for each new look
...
Learn how to input a model reference and swap the garment input for each new look. Pose and lighting nodes stay locked across the set for a consistent editorial feel. [Open Editorial photoshoot template](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:cfd7b810-2f86-5cdf-af80-dd2e31b8b84b).
